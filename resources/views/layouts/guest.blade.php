...
<body class="text-white/85 font-sans antialiased min-h-screen flex items-center justify-center relative overflow-hidden" style="background: #0a0e1a;">
    ...
    @else
        <div class="absolute inset-0 bg-gradient-to-br from-accent/10 via-dark-bg to-surface pointer-events-none"></div>
