...
<div x-data="{ showPassword: false, showConfirm: false }" class="w-full max-w-md mx-auto">
    <div class="backdrop-blur-2xl bg-white/5 border border-white/10 rounded-2xl p-8 shadow-2xl">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-heading font-bold text-white mb-2">Reset Kata Sandi</h1>
            <p class="text-text-muted/80 text-sm">Buat kata sandi baru</p>
        </div>
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5">
            ...
            <div>
                <label for="password" class="block text-sm font-medium text-text-muted mb-2">Kata Sandi Baru</label>
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                        <svg class="w-5 h-5 text-text-muted/50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
